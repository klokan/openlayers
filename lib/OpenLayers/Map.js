...
OpenLayers.Map = OpenLayers.Class({
  ...
  // Options
    ...
    initialize: function (div, options) {
        ...
        if (!this.controls) {
            if (OpenLayers.Control) { // running full or lite?
        ...
        for(var k=0, len=this.controls.length; k<len; k++) {
            this.addControlToMap(this.controls[k]);
        }
    ...
    setBaseLayer: function(newBaseLayer) {
        ...
        if (newBaseLayer != this.baseLayer) {
            ...
            if (OpenLayers.Util.indexOf(this.layers, newBaseLayer) != -1) {
                ...
                if (this.baseLayer && !this.allOverlays) {
  ...
  /********************************************************/         
    ...
    addControlToMap: function (control, px) {
        ...
        // viewport.
        control.outsideViewport = !!control.div;
   ...
   /** 
        ...
        if (dx || dy) {
            ...
            if (dx) {
                this.layerContainerDiv.style.left =
                    parseInt(this.layerContainerDiv.style.left, 10) - dx + "px";
                this.minPx.x -= dx;
                this.maxPx.x -= dx;
            }
            if (dy) {
                this.layerContainerDiv.style.top =
                    parseInt(this.layerContainerDiv.style.top, 10) - dy + "px";
                this.minPx.y -= dy;
                this.maxPx.y -= dy;
            }
            var layer, i, len;
    ...
    moveTo: function(lonlat, zoom, options) {
        ...
        if (zoomChanged || centerChanged || dragging) {
            ...
            if (zoomChanged || !this.layerContainerOrigin) {
            ...
            if (zoomChanged) {
                //redraw popups
                for (var k=0, len=this.popups.length; k<len; k++) {
                    this.popups[k].updatePosition();
                }
    ...
    centerLayerContainer: function (lonlat) {
        ...
        if ((originPx) && (newPx)) {
            var oldLeft = parseInt(this.layerContainerDiv.style.left, 10);
            var oldTop = parseInt(this.layerContainerDiv.style.top, 10);
  ...
  /********************************************************/
    ...
    getResolution: function () {
        ...
        } else if(this.allOverlays && this.layers.length > 0) {
  ...
  //
    ...
    getViewPortPxFromLayerPx:function(layerPx) {
        var viewPortPx = null;
        if (layerPx) {
            var dX = parseInt(this.layerContainerDiv.style.left, 10);
            var dY = parseInt(this.layerContainerDiv.style.top, 10);
